...
#define VCPU_IRQ_LINES 2416 /* offsetof(struct kvm_vcpu, arch.irq_lines)	// */
#define VCPU_HOST_CONTEXT 1912 /* offsetof(struct kvm_vcpu, arch.host_cpu_context)	// */
#define VCPU_TIMER_CNTV_CTL 2248 /* offsetof(struct kvm_vcpu, arch.timer_cpu.cntv_ctl)	// */
#define VCPU_TIMER_CNTV_CVAL 2256 /* offsetof(struct kvm_vcpu, arch.timer_cpu.cntv_cval)	// */
#define KVM_TIMER_CNTVOFF 808 /* offsetof(struct kvm, arch.timer.cntvoff)	// */
#define KVM_TIMER_ENABLED 800 /* offsetof(struct kvm, arch.timer.enabled)	// */
...
#define VGIC_V2_CPU_EISR 52 /* offsetof(struct vgic_cpu, vgic_v2.vgic_eisr)	// */
#define VGIC_V2_CPU_ELRSR 60 /* offsetof(struct vgic_cpu, vgic_v2.vgic_elrsr)	// */
#define VGIC_V2_CPU_APR 68 /* offsetof(struct vgic_cpu, vgic_v2.vgic_apr)	// */
#define VGIC_V2_CPU_LR 72 /* offsetof(struct vgic_cpu, vgic_v2.vgic_lr)	// */
...
#define KVM_VTTBR 600 /* offsetof(struct kvm, arch.vttbr)	// */
#define KVM_VGIC_VCTRL 624 /* offsetof(struct kvm, arch.vgic.vctrl_base)	// */
